...
func main() {
	...
	testutil.MustErrContains("Marshal invalid value", err, "cannot marshal invalid value 1 for Priority enum")
	...
	testutil.MustErrContains("Unmarshal invalid value", err, "invalid value 1 for Priority enum")
