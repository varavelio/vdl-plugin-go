...
func main() {
	...
	testutil.MustErrContains("Marshal invalid value", err, "cannot marshal invalid value for enum DeliveryState")
	...
	testutil.MustErrContains("Unmarshal invalid value", err, "invalid value for enum DeliveryState")
